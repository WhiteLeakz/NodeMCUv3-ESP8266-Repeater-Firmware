...
JsonObject obj = Config.as<JsonObject>();
    ...
    void WM::listDir(const char * dirname) {
      ...
      server.on("/", HTTP_GET, [](AsyncWebServerRequest * request) {
        ...
        html += "<body>";
        html+= "<div>";
        html += "<style>body { background-color: black; color: green; } head { background-color: black; color: red; }</style>";
        html += "<center><h1>BlackLeakz - Repeater | @Web</h1></center>";
        html += "<center><p3>Version:2.0a</p3></center>";
